...
// import { getMakerBalances, listAdvances } from "../api/advanceApi";
// import { getCheckerDashboard, getMakerDashboard } from "../api/dashboardApi";
...
export default function DashboardPage() {
  ...
  const fetchDashboardData = useCallback(
    ...
    async (showLoader = false) => {
      ...
      if (disableAPI) {
  console.log("Dashboard API disabled");
  setLoading(false);
  return;
}
      if (dashboardRequestRef.current) {
...
if (!dashboard) {
  setDashboard({
    ...
    total_verified_spend: 50000,
    pending_reviews: 5,
    pending_approvals: 3,
    pending_bill_verifications: 2,
  });
}
